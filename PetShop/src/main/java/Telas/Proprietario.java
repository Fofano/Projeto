...
import DAO.ConexaoDoProprietario;
...
public class Proprietario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ProprietarioM Prop = new ProprietarioM();
        Prop.setCpf(CPF.getText());
        Prop.setNome(Nome.getText());
        Prop.setEndereco(Endereço.getText());
        Prop.setNumero(Numero.getText());
        Prop.setPet(Pet.getText());
        ConexaoDoProprietario con = new ConexaoDoProprietario();
        con.ConexaoDoProprietario(Prop);
